...
func (im *innerMap) set(key Partitionable, v interface{}) (interface{}, bool) {
	var ok bool
	var val interface{}
	keyVal := key.Value()
...
func (im *innerMap) _set(key Partitionable, v interface{}) {
	keyVal := key.Value()
	im.lock.Lock()
	im.m[keyVal] = v
	im.lock.Unlock()
...
func (m *ConcurrentMap) Set(key Partitionable, v interface{}) (interface{}, bool) {
